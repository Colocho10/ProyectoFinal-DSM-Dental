package com.example.proyecto_registro_dsm
...
import com.example.proyecto_registro_dsm.databinding.ActivityRegistrationBinding
...
class RegistrationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnEnviarRegistro.setOnClickListener {
            ...
            val dui = binding.eTxtDuiRegistro.text.toString()
            ...
            if (nombre.isNotEmpty() && apellido.isNotEmpty() && telefono.isNotEmpty() && genero.isNotEmpty() && fechanac.isNotEmpty() && pais.isNotEmpty() && dui.isNotEmpty() && direccion.isNotEmpty() && email.isNotEmpty() && password.isNotEmpty()) {
                registrarUsuario(
                    nombre,
                    apellido,
                    telefono,
                ...
                if (task.isSuccessful) {
                    ...
                    db.collection("users").document(uid).set(map).addOnSuccessListener {
                        ...
                        .addOnFailureListener {
                            Toast.makeText(
                                this,
                                "Fallo al guardar la información",
                                Toast.LENGTH_SHORT
                            ).show()
                        }
                } else {
